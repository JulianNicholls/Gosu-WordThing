...
module WordThing
  ...
  class Drawer
    ...
    def words(list)
      ...
      list.each do |w|
        font.draw_text(w.word, pos.x, pos.y, 1, 1, 1, BLUE)
    ...
    def current(word)
      ...
      font.draw_text(word, pos.x, pos.y, 1, 1, 1, colour)
    end
    ...
    def total_score(pos, font)
      ...
      font.draw_text('Total', pos.x, pos.y, 1, 1, 1, TOTAL_COLOUR)
    ...
    def render_score(score, top, font, colour)
      ...
      font.draw_text(score, left, top, 1, 1, 1, colour)
    end
